    ...
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch">
      ...
      <el-form-item label="Permission String" prop="roleKey">
        <el-input
          ...
          placeholder="Please enter the permission string"
          clearable
          style="width: 240px"
          @keyup.enter.native="handleQuery"
        />
      ...
      <el-form-item label="Created Time">
        <el-date-picker
          ...
          type="daterange"
          range-separator="-"
          start-placeholder="Started Time"
          end-placeholder="Ended Time"
        ></el-date-picker>
      </el-form-item>
      <el-form-item>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" >
        ...
        <el-form-item prop="roleKey">
          ...
          <el-input v-model="form.roleKey" placeholder="Please enter the permission string" />
        </el-form-item>
...
export default {
  ...
  data() {
    return {
      ...
      dataScopeOptions: [
        ...
        {
          value: "5",
          label: "Personal Data Permissions"
        }
      ],
      // 菜单列表
      menuOptions: [],
  ...
  methods: {
    ...
    handleStatusChange(row) {
      ...
      this.$modal.confirm('Confirm' + "\t" + text + "\t" + row.roleName + '?').then(function() {
    ...
    handleDataScope(row) {
      ...
      this.title = "Set Data Permissions";
    },
    /** 分配用户操作 */
        ...
        if (valid) {
          if (this.form.roleId != undefined) {
            ...
            updateRole(this.form).then(response => {
              this.$modal.msgSuccess("Successfully Update");
              this.open = false;
              this.getList();
            });
          } else {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('Confirm delete roleId\t' + roleIds + '?').then(function() {
