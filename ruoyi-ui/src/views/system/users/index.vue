<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="用户角色 (PM、Developer等)" prop="role">
        <el-input
          v-model="queryParams.role"
          placeholder="请输入用户角色 (PM、Developer等)"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      <el-form-item label="账号创建时间" prop="createdAt">
      ...
      <el-form-item label="账号更新时间" prop="updatedAt">
        <el-date-picker clearable
          v-model="queryParams.updatedAt"
          type="date"
          value-format="yyyy-MM-dd"
          placeholder="请选择账号更新时间">
        </el-date-picker>
      </el-form-item>
      <el-form-item>
    ...
    <el-table v-loading="loading" :data="usersList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="用户角色 (PM、Developer等)" align="center" prop="role" />
      <el-table-column label="账号创建时间" align="center" prop="createdAt" width="180">
        <template slot-scope="scope">
          <span>{{ parseTime(scope.row.createdAt, '{y}-{m}-{d}') }}</span>
        </template>
      </el-table-column>
      <el-table-column label="账号更新时间" align="center" prop="updatedAt" width="180">
        <template slot-scope="scope">
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="用户角色 (PM、Developer等)" prop="role">
          <el-input v-model="form.role" placeholder="请输入用户角色 (PM、Developer等)" />
        </el-form-item>
        <el-form-item label="账号创建时间" prop="createdAt">
          <el-date-picker clearable
