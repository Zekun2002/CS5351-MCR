    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['software:member:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['software:member:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['software:member:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['software:member:export']"
        >导出</el-button>
      </el-col>
...
<script>
import { listMember, getMember, delMember, addMember, updateMember } from "@/api/software/member";
...
export default {
  ...
  methods: {
    ...
    handleUpdate(row) {
      ...
      getMember(taskMemberId).then(response => {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除任务成员管理编号为"' + taskMemberIds + '"的数据项？').then(function() {
        return delMember(taskMemberIds);
      }).then(() => {
        this.getList();
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('software/member/export', {
        ...this.queryParams
