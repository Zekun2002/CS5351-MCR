...
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '任务成员表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of task_members
-- ----------------------------
INSERT INTO `task_members` VALUES (1, 1, 1, '2025-11-23 00:00:00');
