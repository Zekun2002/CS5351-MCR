...
public interface TaskMembersMapper {
     ...
     * @return 结果
     */
    public TaskMembers selectTaskMembersByTaskAndUserId(TaskMembers taskMembers);
     ...
     * 根据任务ID & 用户ID删除任务成员
     *
     * @param taskMembers 需要删除的数据主键集合
     * @return 结果
     */
    public int deleteTaskMembers(TaskMembers taskMembers);
